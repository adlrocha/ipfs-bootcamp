module github.com/adlrocha/ipfs-bootcamp/libp2p

go 1.17

require (
	github.com/adlrocha/libp2p-boilerplate v0.0.0-20210819085400-7ad64ce2d087
...
require (
	...
	github.com/ipld/go-ipld-prime v0.11.1-0.20210814231128-df94e6a99727 // indirect
